      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold tracking-wider mb-4">
              INKED <span className="text-[#ff3333]">CREATIONS</span>
            </h3>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Award-winning tattoo studio bringing your artistic visions to life since 2012.
            </p>
          </div>
          <div>
            <h4 className="text-lg font-bold mb-4 uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2 text-zinc-400">
              {["Home", "Services", "Artists", "Gallery", "Contact"].map((link) => (
                <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="hover:text-[#ff3333] transition-colors">
                    {link}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-500 text-sm">
            © 2024 Inked Creations. All rights reserved.
          </p>
