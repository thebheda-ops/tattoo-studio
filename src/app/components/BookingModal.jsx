...
export default function BookingModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    const vendorWhatsApp = "15551234567"; // Replace with actual vendor WhatsApp number
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-zinc-950 border border-zinc-800 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black border border-zinc-700 px-4 py-3 text-white focus:border-[#ff3333] focus:outline-none transition-colors"
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full bg-[#ff3333] hover:bg-[#cc0000] disabled:bg-zinc-700 disabled:cursor-not-allowed py-4 text-lg uppercase tracking-widest font-semibold transition-colors"
                >
                  Continue
                </button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="button"
                  onClick={prevStep}
                  className="flex-1 border border-zinc-700 hover:border-white py-4 text-lg uppercase tracking-widest font-semibold transition-colors"
                >
                  Back
                </button>
                <button
                  ...
                  className="flex-1 bg-[#ff3333] hover:bg-[#cc0000] disabled:bg-zinc-700 disabled:cursor-not-allowed py-4 text-lg uppercase tracking-widest font-semibold transition-colors"
                >
                  Continue
                </button>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-black border border-zinc-700 px-4 py-3 text-white focus:border-[#ff3333] focus:outline-none transition-colors resize-none"
                  placeholder="Describe your tattoo idea in detail. Include any reference images you plan to bring..."
                />
              </div>
              ...
              <div className="bg-zinc-900/50 p-4 border border-zinc-800">
                <p className="text-zinc-400 text-sm">
                  ...
                  Please send the message to complete your booking request.
                </p>
              </div>
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  className="flex-1 bg-[#ff3333] hover:bg-[#cc0000] disabled:bg-zinc-700 disabled:cursor-not-allowed py-4 text-lg uppercase tracking-widest font-semibold transition-colors flex items-center justify-center gap-2"
                >
